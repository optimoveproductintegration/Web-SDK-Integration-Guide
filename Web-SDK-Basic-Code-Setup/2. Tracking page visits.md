...
* Set the This trigger fires on to All Custom Events.
...
## Step 2
* Return to the _initialize_sdk_tag_ you defined previously and add the following event into the dataLayer.push() function that you added previously in the Custom HTML field: 
...
## Step 4
* Open the custom HTML for _page_visit_tag_.
