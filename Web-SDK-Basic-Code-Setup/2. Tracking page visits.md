...
## Step 2
* Return to the _initialize_sdk_tag_ tag you defined previously and add the following event into the dataLayer.push() function that you added previously in the Custom HTML field: 
